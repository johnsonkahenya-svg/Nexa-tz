...
async function start() {
    ...
    sock.ev.on("messages.upsert", async ({ messages }) => {
        ...
        if (isSticker(m)) {
            ...
            return send(sock, jid, "🚫 Sticker imefutwa kwa sababu huruhusiwi kutuma sticker ndani ya group tafadhari tuwe waelewa", m)
        }
...
🧾 Desc: ${metadata.desc?.slice(0, 50) || "No description"}
`, m)
        }
